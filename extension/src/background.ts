...
import type { ExtractedJob, ExtensionSettings, Message, IngestPayload } from "./types.js";
...
// ---- 去重合并 ----
async function mergeJobs(newJobs: ExtractedJob[]): Promise<number> {
...
// ---- 同步到 OfferU 后端 ----
async function syncToServer(): Promise<{ ok: boolean; synced: number; error?: string }> {
